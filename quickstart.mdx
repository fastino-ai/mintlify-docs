...
<Steps>
  ...
  <Step title="Use the Anthropic-compatible endpoint (optional)">
    If you're already using the Anthropic SDK, point it at `https://api.pioneer.ai` and use your Pioneer API key.
    ...
    Pass Pioneer-specific fields like `schema` through the SDK's extra-body option.
  </Step>
