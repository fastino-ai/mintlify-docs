---
title: "Catalogue de modèles Pioneer : encodeurs et décodeurs"
sidebarTitle: "Catalogue de modèles"
description: "Parcourez les modèles encodeurs (GLiNER) et décodeurs (LLM) de Pioneer pour le fine-tuning et l'inférence, en mode à la demande ou sans serveur."
---
