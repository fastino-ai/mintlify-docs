...
description: "Fastino stocke et versionne automatiquement vos datasets d'entraînement. Découvrez comment les créer par génération ou auto-étiquetage, puis les lister, les inspecter et les supprimer."
---
...
**Génération de données synthétiques** — Utilisez `POST /generate` pour que Fastino produise des exemples étiquetés à partir d'une description de votre domaine et des labels qui vous intéressent. C'est le moyen le plus rapide d'amorcer un dataset sans aucune donnée étiquetée existante.
