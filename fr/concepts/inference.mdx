...
description: "Exécutez l'inférence sur Pioneer via l'endpoint natif /inference, les chat completions compatibles OpenAI ou les messages compatibles Anthropic."
---
