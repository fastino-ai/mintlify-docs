...
<Steps>
  ...
  <Step title="Listez les modèles de base disponibles (optionnel)">
  ...
  <Step title="Utilisez l'endpoint compatible Anthropic (optionnel)">
    Si vous utilisez déjà le SDK Anthropic, pointez-le vers `https://api.fastino.ai` et utilisez votre clé d'API Fastino.
