...
| `POST /v1/chat/completions`, `/v1/responses`, `/v1/messages` | Par utilisateur | 5 000 / min |
| `POST /v1/gliner-2/*` | Par utilisateur | 15 000 / min |
| `POST /v1/generate/*` | Par utilisateur | 120 / min |
| `POST /v1/felix/training-jobs` | Par utilisateur | 20 / min |
...
Si les limites par défaut ou du palier Pro ne conviennent pas à votre charge de travail, contactez l'équipe Fastino pour discuter d'un plan personnalisé.
