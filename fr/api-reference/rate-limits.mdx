---
title: "Limites de débit et plafonds de crédits / de dépenses pour l'API Fastino"
description: "Limites de débit de requêtes par endpoint, quotas WAF en périphérie, limites d'utilisation basées sur les crédits et plafonds de dépenses en dépassement, gestion des erreurs 429, et comment demander des limites plus élevées pour l'API Fastino."
---
