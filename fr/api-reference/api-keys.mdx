...
description: "Créez des clés API Fastino depuis le tableau de bord, puis listez et révoquez les clés de manière programmatique. La clé secrète complète n'est renvoyée qu'à la création. Stockez-la immédiatement dans un gestionnaire de secrets."
---
