...
<Steps>
  <Step title="Choose a base model">
    Pioneer supports GLiNER2 training targets for general NER workloads. For most tasks, `fastino/gliner2-base-v1` is the right starting point. If your data includes non-English text, use a `multi` variant instead.
