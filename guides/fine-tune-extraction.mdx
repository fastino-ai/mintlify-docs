---
title: "Fine-tune a GLiNER structured extraction model on Pioneer"
sidebarTitle: "Extraction Fine-tuning"
description: "Train a custom JSON extraction model on Pioneer's GLiNER encoders to pull invoices, forms, and structured records out of unstructured text — data to inference."
---
...
<Steps>
  <Step title="Choose a base model">
    Pioneer supports GLiNER2 training targets for general extraction workloads. For most tasks, `fastino/gliner2-base-v1` is the right starting point. If your documents include non-English text, use a `multi` variant instead.
