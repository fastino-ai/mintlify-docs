---
title: "Fine-tune a GLiNER text classification model on Pioneer"
sidebarTitle: "Classification Fine-tuning"
description: "Train a custom single- or multi-label text classification model on Pioneer's GLiNER encoders, from dataset prep through evaluation and inference on your data."
---
...
<Steps>
  <Step title="Choose a base model">
    Pioneer supports GLiNER2 training targets for general classification workloads. For most tasks, `fastino/gliner2-base-v1` is the right starting point. If your data includes non-English text, use a `multi` variant instead.
