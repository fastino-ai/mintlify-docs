---
title: "POST /inference — Fastino native inference endpoint"
...
- [OpenAI-compatible inference](/api-reference/inference/openai-compatible) — call Fastino models through the OpenAI SDK
- [Anthropic-compatible inference](/api-reference/inference/anthropic-compatible) — call Fastino models through the Anthropic SDK
