...
2. Open ~/.hermes/config.yaml and point Hermes at Pioneer:
...
4. Hermes will auto-discover all available Pioneer models from the inference endpoint. To browse the full list:
