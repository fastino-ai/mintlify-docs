...
| `POST /v1/chat/completions`, `/v1/responses`, `/v1/messages` | Per user | 5,000 / min |
| `POST /v1/gliner-2/*` | Per user | 15,000 / min |
| `POST /v1/generate/*` | Per user | 120 / min |
| `POST /v1/felix/training-jobs` | Per user | 20 / min |
...
If the default or Pro-tier limits don't fit your workload, contact the Fastino team to discuss a custom plan.
