---
title: "Rate limits and daily spending caps for the Pioneer API"
description: "Per-endpoint request-rate limits, edge WAF quotas, daily spending caps, 429 error handling, and how to request higher limits for the Pioneer API."
---
