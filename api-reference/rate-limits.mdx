...
description: "Per-endpoint request-rate limits, edge WAF quotas, monthly credit and overage spending caps, 429 handling, and how to request higher limits on the Pioneer API."
---
