...
description: "How prompt caching works on Pioneer's inference API — what qualifies for caching, how cached input tokens are billed, and where to view cache hit rates."
---
