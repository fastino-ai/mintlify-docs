...
description: "Authenticate Pioneer API requests with the X-API-Key header. Generate keys in the dashboard, then list, rotate, or revoke them programmatically."
---
