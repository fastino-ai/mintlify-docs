---
title: "Fastino API error codes and response body shapes"
sidebarTitle: "Errors"
description: "Every 4xx and 5xx status code the Fastino API returns, the JSON body shape for each family, and steps to resolve billing, rate-limit, and validation errors."
noindex: true
---
...
**How to fix:** Log in to [Fastino](https://fastino.ai), go to **Settings** → **Billing**, and top up your balance or upgrade your plan. See [Credit limits and overage spending cap](/api-reference/rate-limits#credit-limits-and-overage-spending-cap) for how credit limits and overage billing work.
