---
title: "Autenticación en la API de Pioneer: generar y usar claves de API"
sidebarTitle: "Autenticación"
description: "Cómo generar una clave de API de Pioneer, pasarla en el encabezado X-API-Key, y listar o revocar claves de forma programática."
---
