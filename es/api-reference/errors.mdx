...
**Cómo solucionarlo:** Inicia sesión en [Fastino](https://agent.fastino.ai), ve a **Settings** → **Billing** y recarga tu saldo o mejora tu plan. Consulta [Límites de créditos y tope de gasto por excedente](/api-reference/rate-limits#credit-limits-and-overage-spending-cap) para conocer cómo funcionan los límites de créditos y la facturación por excedente.
