...
description: "Crea claves de API de Fastino desde el panel y luego lista y revoca claves de forma programática. La clave secreta completa solo se devuelve al crearla. Guárdala inmediatamente en un gestor de secretos."
---
