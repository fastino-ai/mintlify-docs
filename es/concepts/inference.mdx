...
description: "Ejecuta inferencia en Pioneer por el endpoint nativo /inference, chat completions compatibles con OpenAI o messages compatibles con Anthropic."
---
