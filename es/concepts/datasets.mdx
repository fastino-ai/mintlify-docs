---
title: "Datasets de Fastino: crear, versionar, inspeccionar y eliminar"
sidebarTitle: "Datasets"
description: "Fastino almacena y versiona tus datasets de entrenamiento automáticamente. Aprende a crearlos mediante generación o auto-etiquetado, y luego a listarlos, inspeccionarlos y eliminarlos."
---
...
**Generación de datos sintéticos.** Usa `POST /generate` para que Fastino produzca ejemplos etiquetados a partir de una descripción de tu dominio y las etiquetas que te interesan. Es la forma más rápida de arrancar un dataset cuando no tienes datos etiquetados previos.
