...
Find answers to the most common questions about Pioneer below. If you don't see what you're looking for, reach out to the team at [support@fastino.ai](mailto:support@fastino.ai).
...
<AccordionGroup>
  <Accordion title="What's the easiest way to fine-tune an SLM?">
    ...
    For a full walkthrough, check out the [NER fine-tuning guide](/guides/ner-fine-tuning) or the [LLM fine-tuning guide](/guides/llm-fine-tuning).
  </Accordion>
  ...
  <Accordion title="Which plan is best for me?">
    It depends on your workload:

    - **Hobby**— best if you want to experiment with new use cases or explore Pioneer before committing.
    ...
    If you're unsure, [contact the team](https://forms.gle/meJ1TuWPi4ryWpHF6) and they'll help you find the right fit.
  </Accordion>
  ...
  <Accordion title="Do you offer any special pricing for students, non-profits, and open source projects?">
    ...
    Complete the [intake form](https://docs.google.com/forms/d/e/1FAIpQLSdgxmKeS69UVk27cII_UNyDO5W2Uo_-T7TBjKnAvOeuKBl0sA/viewform) to apply. The team will follow up with your custom pricing.
  </Accordion>
