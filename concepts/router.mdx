---
title: "Pioneer Model Router: automatic per-request model selection"
description: "The Pioneer Router picks the cheapest model that meets your quality bar on every coding request. Send pioneer/auto and cut cost without changing your app."
---
