...
The UI exposes named effort tiers that map to preset `threshold`, `max_regret`, and `allowed_models` combinations.

| Tier | Threshold | Max regret | Candidate pool |
| --- | --- | --- | --- |
| `low` | 0.05 | 0.30 | Cheapest 3 only |
| `medium` | 0.10 | 0.20 | Cheapest 5 |
| `high` | 0.20 | 0.15 | All 8 (default) |
| `xhigh` | 0.35 | 0.08 | All 8 |
| `max` | 0.60 | 0.03 | All 8 |
| `ultracode` | 0.95 | 0.01 | GPT-5.5 \+ Claude Opus 4.7 only |
