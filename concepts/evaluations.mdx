...
<Note>
  Evaluating a decoder LLM instead? Pioneer's OpenAI-compatible API works with third-party eval tools as-is. See [Evaluate Pioneer models with Braintrust](/guides/braintrust-evals).
</Note>
