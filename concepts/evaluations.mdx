...
<Note>
  Evaluating a decoder LLM instead? Pioneer's OpenAI-compatible API works with third-party eval tools as-is. See [Evaluate Pioneer models with Braintrust and Prime Intellect](/guides/third-party-evals).
</Note>
