...
**Synthetic data generation** — Use `POST /generate` to have Fastino produce labeled examples from a description of your domain and the labels you care about. This is the fastest way to bootstrap a dataset without any existing labeled data.
