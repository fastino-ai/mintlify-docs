...
**如何修复：** 登录 [Fastino](https://agent.fastino.ai)，前往 **Settings** → **Billing**，充值或升级套餐。有关额度限制及超额计费的工作方式，请参见[额度限制和超额消费上限](/api-reference/rate-limits#credit-limits-and-overage-spending-cap)。
