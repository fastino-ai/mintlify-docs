...
description: "在 Pioneer 上运行推理:通过原生 /inference 端点、兼容 OpenAI 的 chat completions 或兼容 Anthropic 的 messages 接口调用相同的解码器和编码器模型,支持 GLiNER、Nemotron、Claude 与 DeepSeek 系列。"
---
