---
title: "Route Cursor chat through Pioneer as a custom model"
description: "Configure Cursor's chat panel to use Pioneer's OpenAI-compatible API, add custom models, and switch between them from the model picker."
---
