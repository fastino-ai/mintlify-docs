...
<Steps>
  ...
  <Step title="Open Cursor Settings">
    Press `Cmd+,` (macOS) or `Ctrl+,` (Windows/Linux), or click the gear icon in the top-right toolbar. Make sure you land on **Cursor Settings**, not **VS Code Settings** — only Cursor Settings has a Models tab.
  </Step>
