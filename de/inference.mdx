...
- `POST /v1/gliner-2` bietet den nativen GLiNER-Vertrag aus dem veröffentlichten
  [OpenAPI-Dokument](https://api.fastino.ai/openapi.json).

Diese Seite dokumentiert den rohen HTTP-Vertrag für `/v1/chat/completions`. Sie behandelt
weder die SDK-Nutzung noch Modelltraining, Evaluation, Inferenz-Historie oder Feedback.
