---
title: "Fastino-Datasets: erstellen, versionieren, inspizieren und löschen"
sidebarTitle: "Datasets"
description: "Fastino speichert und versioniert Ihre Trainings-Datasets automatisch. Erfahren Sie, wie Sie sie per Generierung oder Auto-Labeling erstellen und anschließend auflisten, inspizieren und löschen."
---
...
**Synthetische Datengenerierung**: Verwenden Sie `POST /generate`, damit Fastino aus einer Beschreibung Ihrer Domäne und den für Sie relevanten Labels gelabelte Beispiele erzeugt. Dies ist der schnellste Weg, ein Dataset ohne bestehende gelabelte Daten aufzubauen.
