---
title: "Rate Limits und Ausgabenobergrenzen der Fastino API"
description: "Anfrage-Rate-Limits pro Endpunkt, Edge-WAF-Kontingente, credit-basierte Nutzungslimits, Overage-Grenzen, 429-Handling und wie Sie höhere Limits anfordern."
---
...
| `POST /v1/chat/completions`, `/v1/responses`, `/v1/messages` | Pro Benutzer | 5.000 / min |
| `POST /v1/gliner-2/*` | Pro Benutzer | 15.000 / min |
| `POST /v1/generate/*` | Pro Benutzer | 120 / min |
| `POST /v1/felix/training-jobs` | Pro Benutzer | 20 / min |
