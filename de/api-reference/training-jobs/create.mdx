...
Gibt `200` mit dem vollständigen Trainingsjob-Datensatz zurück. Speichern Sie die `id` und pollen Sie [`GET /felix/training-jobs/{job_id}`](/de/api-reference/training-jobs/get).
