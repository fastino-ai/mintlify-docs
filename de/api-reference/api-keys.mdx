---
title: "Verwaltung von Fastino-API-Schlüsseln: erstellen, auflisten und widerrufen"
sidebarTitle: "API Keys"
description: "Erstellen Sie Fastino-API-Schlüssel im Dashboard und listen bzw. widerrufen Sie Schlüssel dann programmatisch. Der vollständige Secret Key wird nur bei der Erstellung zurückgegeben. Speichern Sie ihn sofort in einem Secrets-Manager."
---
