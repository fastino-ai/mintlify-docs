---
title: "Fastino-API-Fehlercodes und Antwortformate"
sidebarTitle: "Fehler"
description: "Alle 4xx- und 5xx-Statuscodes der Fastino API, das JSON-Antwortformat je Fehlerfamilie und Wege zur Behebung von Billing-, Rate-Limit- und Validierungsfehlern."
---
...
**Behebung:** Überprüfen Sie die ID oder den Namen im Anfragepfad oder -body sorgfältig. Verwenden Sie den entsprechenden `GET`-Listenendpunkt (zum Beispiel `GET /v1/felix/training-jobs`, `GET /v1/base-models`), um zu bestätigen, dass die Ressource existiert.
...
- Weglassen von `base_model` bei `POST /v1/felix/training-jobs`
- Übergabe eines nicht unterstützten `task_type` an `POST /v1/generate`
