...
Questions? [security@fastino.ai](mailto:security@fastino.ai)
...
It is written for the engineers integrating Fastino.ai and the security teams reviewing us. If you need something not covered here, such as a security questionnaire, subprocessor list, or a signed agreement, reach out at [security@fastino.ai](mailto:security@fastino.ai).
...
If you or your users need to access, export, or delete personal data, contact [security@fastino.ai](mailto:security@fastino.ai) and we will respond within the timelines required by applicable law.
...
We are in our observation window and expect to complete our first audit in November 2026. If you need our current documentation or to be notified when a report is available, email [security@fastino.ai](mailto:security@fastino.ai).
...
If you find a vulnerability or see our models being misused, tell us. Email [security@fastino.ai](mailto:security@fastino.ai) with details and, for vulnerabilities, steps to reproduce. We investigate every report.

For questions about this page contact [security@fastino.ai](mailto:security@fastino.ai).