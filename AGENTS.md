...
- Use the [Fastino GLiNER agent skill](https://docs.fastino.ai/concepts/gliner-agent-skill) for GLiNER workflows and `GET /v1/models` for current model availability.
