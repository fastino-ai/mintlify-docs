...
description: "Install the Pioneer CLI on macOS, Linux, or Windows, authenticate with your API key, and verify the setup by running your first command in the terminal."
